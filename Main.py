...
with st.echo(code_location='below'):
    ...
    def read_zipfile(data_url):
        link = 'D:\FinalProject\ ' + data_url
        zf = zipfile.ZipFile(link)
        return(pd.read_csv(zf.open('intfile.csv')))
    ...
    """
    # Парсинг
    df_dost = read_file("parsed_data.zip")
    df_dost['dist'] = 0
    ...
    """
    df_moscow = read_file("moscowhome_data.zip")

    df_moscow1 = read_file("moscowdist_data.zip")
